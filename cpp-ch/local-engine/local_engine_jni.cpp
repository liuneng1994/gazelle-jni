...
JNIEXPORT void
Java_org_apache_spark_sql_udaf_RoaringBitmapJniTest_testCRoaringBitmap(JNIEnv * env, jclass /*clazz*/)
{
    LOCAL_ENGINE_JNI_METHOD_START
    int size = 6000;
    std::unique_ptr<local_engine::KeRoaringBitmapData<Int64>> bitmap_array[size];

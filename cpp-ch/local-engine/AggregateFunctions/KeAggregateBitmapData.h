...
static constexpr size_t BITMAP_DATA_BUFF_SIZE = 32768;
...
template <typename T>
std::atomic<UInt64> KeRoaringBitmapData<T>::read_time(0);
template <typename T>
std::atomic<UInt64> KeRoaringBitmapData<T>::read_buff_time(0);
template <typename T>
std::atomic<UInt64> KeRoaringBitmapData<T>::or_time(0);
template <typename T>
std::atomic<UInt64> KeRoaringBitmapData<T>::write_time(0);
template <typename T>
std::atomic<UInt64> KeRoaringBitmapData<T>::write_buff_time(0);
